...
bot_ad = Button(janela, text='+', padx=39, pady=20, command=lambda: click())
bot_ig = Button(janela, text='=', padx=91, pady=20, command=lambda: click())
bot_lim = Button(janela, text='Clear', padx=79, pady=20, command=lambda: click())
